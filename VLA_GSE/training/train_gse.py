...
"""
VLA-GSE GSE (Generalized and Specialized Expert) trainer for Multi-GPU (No DeepSpeed).
...
class AccelerateGSETrainer:
    """Trainer for GSE-based VLA finetuning on Multi-GPU"""
    ...
    def _log_training_config(self):
        ...
        if not self.accelerator.is_main_process:
            return
        logger.info("***** GSE (Generalized and Specialized Expert) Multi-GPU Training Configuration *****")
...
def main(cfg) -> None:
    logger.info("VLA GSE (Generalized and Specialized Expert) Multi-GPU Training :: Warming Up")
