...
"""
StarVLA's LoRA trainer.
Based on train_starvla.py, but uses LoRA for the VLM backbone while keeping the action head fully trainable.
...
def main(cfg) -> None:
    logger.info("VLA LoRA Training :: Warming Up")
