...
fast_token_list=VLA_GSE/model/modules/vlm/tools/add_qwen_special_tokens/fast_tokens.txt

python VLA_GSE/model/modules/vlm/tools/add_qwen_special_tokens/add_special_tokens_to_qwen.py \
