...
_ACTION_TOKEN_MAX = 153716 # here only for fast_tokenizer, see VLA_GSE/model/modules/vlm/tools/add_qwen_special_tokens/README.md
...
class _QWen3_VL_Interface(nn.Module):
    ...
    def __init__(self, config: Optional[dict] = None, **kwargs):
        ...
        # Normalize and detect local path so huggingface_hub does not validate as repo_id
        if isinstance(model_id, str):
            model_id = os.path.normpath(model_id.rstrip("/"))
        is_local = isinstance(model_id, str) and (os.path.isdir(model_id) or os.path.isfile(model_id))
    ...
    def build_qwenvl_inputs(self, images, instructions, solutions=None, **kwargs):
        ...
        if solutions is not None: #  here only for fast_tokenizer now. 
            ...
            action_token_max = _ACTION_TOKEN_MAX # here only for fast_tokenizer, see VLA_GSE/model/modules/vlm/tools/add_qwen_special_tokens/README.md
            ...
            for i in range(labels.size(0)):
                ...
                if nonzero_indices.numel() > 0:
                    ...
                    seq[:] = IGNORE_INDEX
                    RuntimeWarning (f"action token are on in yout tokenizer, plz see VLA_GSE/model/modules/vlm/tools/add_qwen_special_tokens/README.md.")
