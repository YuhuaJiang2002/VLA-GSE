...
Each framework module (e.g., M1.py, QwenFast.py) should register itself:
    from VLA_GSE.model.framework.framework_registry import FRAMEWORK_REGISTRY
...
def build_framework(cfg):
    ...
    if cfg.framework.name == "QwenOFT":
        from VLA_GSE.model.framework.QwenOFT import Qwenvl_OFT
        return Qwenvl_OFT(cfg)
    elif cfg.framework.name == "QwenFast":
        from VLA_GSE.model.framework.QwenFast import Qwenvl_Fast
