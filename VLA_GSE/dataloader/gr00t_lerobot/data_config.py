...
from VLA_GSE.dataloader.gr00t_lerobot.datasets import ModalityConfig
from VLA_GSE.dataloader.gr00t_lerobot.transform.base import ComposedModalityTransform, ModalityTransform
from VLA_GSE.dataloader.gr00t_lerobot.transform.concat import ConcatTransform
from VLA_GSE.dataloader.gr00t_lerobot.transform.state_action import (
    StateActionSinCosTransform,
    StateActionToTensor,
    StateActionTransform,
)
from VLA_GSE.dataloader.gr00t_lerobot.transform.video import (
    VideoColorJitter,
    VideoCrop,
    VideoResize,
    VideoToNumpy,
...
class AgilexDataConfig:
    ...
    action_keys = [
        "action.left_joints",
        "action.right_joints",#@author this order is different from Dataset
        "action.left_gripper",
        "action.right_gripper",
    ]
